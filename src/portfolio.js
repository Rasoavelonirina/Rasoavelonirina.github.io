...
const seo = {
  ...
  description:
    "A passionate person who always thrives on working on end-to-end products that develop sustainable, scalable systems for data processing and thus create impact.",
  og: {
